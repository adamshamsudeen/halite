...
All starter kits should contain a `run_game.sh` and `run_game.bash`, you can use this scripts to quickly run a game of halite. By default, this script runs the basic __Settler__ bot against itself.
